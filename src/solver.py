...
class solver_GP(object):
    ...
    def show_sample(self):
        ...
        plt.savefig(f"fig/{self.PDE_type}_collocation.png")
    ...
    def show_sample_IP(self):
        ...
        plt.savefig(f"fig/{self.PDE_type}_collocation_ip.png")
    ...
    def show_loss_hist(self):
        ...
        plt.savefig(f"fig/{self.PDE_type}_loss.png")
    ...
    def contour_of_test_err(self, XX, YY):
        ...
        plt.savefig(f"fig/{self.PDE_type}_err.png")
        # plt.show()
    ...
    def contour_of_three_plot(self, XX, YY):
        ...
        # fig.colorbar(err_contourf, format=fmt)
        plt.tight_layout()
        plt.savefig(f"fig/{self.PDE_type}_result.png")
